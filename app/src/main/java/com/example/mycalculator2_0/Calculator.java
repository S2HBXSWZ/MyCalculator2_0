package com.example.mycalculator2_0;
...
public class Calculator extends AppCompatActivity {
    ...
    private static StringBuilder show_equation = new StringBuilder();
    private static ArrayList calculate_equation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*Button change = (Button) findViewById(R.id.mode);
        change.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Calculator.this,Pro.class);
